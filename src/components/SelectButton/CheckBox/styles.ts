...
export const vWidth = 64 + margin;
export const vHeight = 64 + margin;
export const checkMarkPath = 'M15 31.1977C23.1081 36.4884 29.5946 43 29.5946 43C29.5946 43 37.5 25.5 69 1.5';
export const outlineBoxPath =
...
export const viewBox = [-margin, -margin, vWidth + margin, vHeight + margin].join(' ');
